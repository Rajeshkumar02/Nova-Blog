...
In the <Navigate path="/blog/Notes_React_Native_V1" label="previous tutorial" />, we set up the project for our notes application in React Native. In this tutorial, we will continue building the application by add the functionality to edit and delete notes. Users will be able to edit the content of their notes and delete notes they no longer need.
